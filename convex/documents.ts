...
export const update = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // updating the database, return Promise<void>. the promise
    // is used to indicate when the action is complete, but there
    // is no meaningful result to return. just updating the database.
    // no return needed.
